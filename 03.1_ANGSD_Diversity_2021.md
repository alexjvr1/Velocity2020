...
~/bin/angsd/misc/realSFS saf2theta MODC.NC_053206.1.MAY26.saf.idx -sfs MODC.fold.sfs -outnames MODC.theta.gz
~/bin/angsd/misc/thetaStat do_stat MODC.theta.idx -win 50000 -step 10000 -outnames MODC.theta.window.gz


~/bin/angsd/misc/realSFS MODE.NC_053206.1.MAY26.saf.idx -fold 1 > MODE.fold.sfs
~/bin/angsd/misc/realSFS saf2theta MODE.NC_053206.1.MAY26.saf.idx -sfs MODE.fold.sfs -outname MODE.theta.gz
~/bin/angsd/misc/thetaStat do_stat MODE.theta.idx -win 50000 -step 10000 -outnames MODE.theta.window.gz


~/bin/angsd/misc/realSFS MUS.NC_053206.1.MAY26.saf.idx -fold 1 > MUS.fold.sfs
~/bin/angsd/misc/realSFS saf2theta MUS.NC_053206.1.MAY26.saf.idx -sfs MUS.fold.sfs -outname MUS.theta.gz
~/bin/angsd/misc/thetaStat do_stat MUS.theta.idx -win 50000 -step 10000 -outnames MUS.theta.window.gz
...
~/bin/angsd/misc/realSFS saf2theta MODC.LR761675.1.MAY26.saf.idx -sfs MODC.fold.sfs -outname MODC.theta.gz
~/bin/angsd/misc/thetaStat do_stat MODC.theta.idx -win 50000 -step 10000 -outnames MODC.theta.window.gz


~/bin/angsd/misc/realSFS MODE.LR761675.1.MAY26.saf.idx -fold 1 > MODE.fold.sfs
~/bin/angsd/misc/realSFS saf2theta MODE.LR761675.1.MAY26.saf.idx -sfs MODE.fold.sfs -outname MODE.theta.gz
~/bin/angsd/misc/thetaStat do_stat MODE.theta.idx -win 50000 -step 10000 -outnames MODE.theta.window.gz


~/bin/angsd/misc/realSFS MUS.LR761675.1.MAY26.saf.idx -fold 1 > MUS.fold.sfs
~/bin/angsd/misc/realSFS saf2theta MUS.LR761675.MAY26.saf.idx -sfs MUS.fold.sfs -outname MUS.theta.gz
~/bin/angsd/misc/thetaStat do_stat MUS.theta.idx -win 50000 -step 10000 -outnames MUS.theta.window.gz
```
