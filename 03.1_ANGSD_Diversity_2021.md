...
D3.MODC.div <- read.table("E3.MODC.theta.window.gz.pestPG", header=T)
D3.MODE.div <- read.table("E3.MODE.theta.window.gz.pestPG", header=T)
D3.MUS.div <- read.table("E3.MUS.theta.window.gz.pestPG", header=T)
